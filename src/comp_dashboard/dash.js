...
//   Personal: personal,
//   Precios: precios,
//   RCSbuenasPracticas: rCSbuenasPracticas,
//   RCSmalasPracticas: rCSmalasPracticas,
...
//   useEffect(() => {
//     fetch('https://quality.fiestaismadrid.net/api/survey/list')
//       .then(response => {
...
//       Cuno: 'Cuno salida',
//       // Custom labels for FICHA_Entorno
...
//       // Custom labels for FICHA_Servicios
...
//       shisas: 'Shishas',
//       // Custom labels for FICHA_Espectaculos
...
//     const customLabels = {
//       vajilla: ['Vaso tubo extra', 'Vaso tubo estandar', 'Copa balon', 'Vaso sidra', 'Vasos plastico', 'Otros'],
//       hielo: ['Seleccionar', 'Macizo pequeño', 'Macizo grande', 'Hueco'],
//       refresco: ['Seleccionar', 'Botellín vidrio', 'Pistola', 'Plastico', 'Lata'],
//       amabilidad: ['Seleccionar', 'Muy Mala', 'Bastante mala', 'Bastante buena', 'Muy Buena'],
//       esperabarra: ['Seleccionar', 'De 1 a 3 min.', 'inmediata', 'De 3 a 5 min.', ' Mas de 5 min.', 'Barra colapsada'],
//       disp_alimentos: ['Seleccionar', 'Desgustación gratuita', 'Hamburguesía', 'No', 'Servicio de restauración', 'Vending'],
//       mesas_reservados: ['No', 'Si'],
//       mesas_num: ['No Data', '10'],
//       mesas_percent: ['No Data', '10%'],
//       venta_botellas: ['No', 'Si'],
//       shisas: ['No', 'Si'],
...
//       marca_bebidas: ['Premium', 'Marcas estandar', 'Marcas blancas', 'Otras']
//     };
//     return customLabels[key] || [];
//   };

//   const renderChart = (data, labelKey, countKey, chartLabel, customLabels = []) => {
...
//     const renderSingleChart = (key) => {
//       const dataObj = data[key][0];
//       const labels = Object.keys(dataObj);
//       const counts = labels.map(label => parseInt(dataObj[label], 10) || 0);
...
//     return (
//       <div>
//         {Object.keys(data).map(key => renderSingleChart(key))}
//       </div>
//     );
//   };
...
//       if (!Array.isArray(dataObj)) return null;
...
//           >
//             <img src={tabImages[tab]} alt={tab} style={{ width: '20px', height: '20px', marginRight: '5px' }} />
//             {tab.replace(/_/g, ' ')}
//           </button>
//         ))}
//       </div>
...
//       try {
//         const response = await fetch('https://quality.fiestaismadrid.net/api/survey/list');
//         if (!response.ok) throw new Error('Network response was not ok');
...
//     return (
//       <div>
//         {Object.keys(data).map(key => renderSingleChart(data[key][0], key))}
//       </div>
//     );
//   };
...
//     return (
//       <div key={key} style={{ flex: '0 0 48%', marginBottom: '20px' }}>
//         <Bar
//           data={chartData}
//           options={{
//             maintainAspectRatio: false,
...
//         // const response = await axios.get('http://localhost:8000/survey-list')
